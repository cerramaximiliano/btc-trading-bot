...
runCronTask("updateTrending", updateTrending, ['startUpDown', 'updateUpDown', 'atr7', 3,  BTC_USDT_BINANCE_15m_Trending_Atr7], '*/5 * * * * *', 'America/Argentina/Buenos_Aires'); 
runCronTask("updateTrending", updateTrending, ['startUpDownArt14Trending3', 'updateUpDownArt14Trend3', 'atr14', 3,  BTC_USDT_BINANCE_15m_Trending_Atr14], '*/1 * * * *', 'America/Argentina/Buenos_Aires'); 
runCronTask("updateTrending", updateTrending, ['startUpDownArt10Trending3', 'updateUpDownArt10Trend3', 'atr10', 3,  BTC_USDT_BINANCE_15m_Trending_Atr10], '*/1 * * * *', 'America/Argentina/Buenos_Aires'); 
